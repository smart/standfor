...
require 'admin/badges_controller'

# Re-raise errors caught by the controller.
class Admin::BadgesController; def rescue_action(e) raise e end; end

class Admin::BadgesControllerTest < Test::Unit::TestCase
  fixtures :admin_badges

  def setup
    @controller = Admin::BadgesController.new
  ...
  def test_should_get_index
    ...
    assert_not_nil assigns(:admin_badges)
  end
